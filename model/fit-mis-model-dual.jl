...
function run_analysis()
    ...
    # [C, w_slope, C_scale, A1, k1, t0_1, A2, k2, t0_2, p_mix]
    # Component 1 (focused/fast): full capacity
    # Component 2 (lapse/slow): scaled capacity (C_scale < 1)
    lower = [1.0,  0.0,   0.01,    0.01, 0.05, 0.05,  0.01, 0.05, 0.15,  0.0]
    upper = [30.0, 10.0,  1.0,     1.0,  1.0,  0.4,   1.0,  1.0,  0.6,   0.99]
    x0    = [10.0, 1.0,   0.5,     0.2,  0.2,  0.2,   0.3,  0.3,  0.35,  0.4]
